            ...
            <table class="table">
                    ...
                    foreach ($_SESSION['cart'] as $sanpham) {
                        ...
                        echo '
                            <tr>
                                ...
                                <td>' . $thanhTien . '</td>
                                <td style="text-align:center"><a href="xoaRongGioHang.php?id=' . $i . '"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                            </tr>
                        ';
                        $i++;
                    }
                ...
                <tbody>
                    <tr>
                        ...
                        <td> <p><a href="payment.php">Tiến hành thanh toán</a></p> </td>
